...
export default function Home({edit, setEdit}) {
  ...
  useEffect(()=>{
    ...
    .catch((err)=>{console.log('home.js - error found..', err)})
  //}
  }, [])
  ...
  return (
    <div>
      <Header />
        <input type='text' className='btn-search' placeholder='search by work' value={search} onChange={handleSearch} />
      <div className="body">
      <table>
        ...
        <tbody>
            ...
            ////console.log('itm', itm)
            return search ===''? key : key.work===(search);
